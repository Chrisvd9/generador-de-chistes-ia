  ...
  return (
    <div className="register mx-auto min-h-screen px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-lg">
        ...
        >
          <div className="relative">
            <input
              type="text"
              name="name"
              placeholder="Introduzca el tema que quiera"
          ...
          <div className="flex items-center justify-center">
            {loading ? (
              ...
              <button
                type="submit"
                className="block w-full rounded-lg bg-[#19C37D] px-5 py-3 text-sm font-medium text-white hover:bg-green-700 cursor-pointer hover:transition"
        ...
        {result && (
          <p className="text-xl font-bold text-white my-10 p-2 text-center">
            {result}
          </p>
        )}
      </div>
